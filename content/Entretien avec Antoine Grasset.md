...
*J'ai rencontré Antoine Grasset lorsque j'étais en alternance chez [Spline](https://spline.fr/fr). Le courant est tout de suite passé avec ce drôle d'énergumène, aussi à l'aise derrière un appareil photo que d'un robot industriel d'une tonne.*
...
<blockquote class="instagram-media" data-instgrm-permalink="https://www.instagram.com/p/BzneA4HCNLc/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==" data-instgrm-version="14">
</blockquote>
</div>
<script async src="//www.instagram.com/embed.js"></script>
...
> ***"Eh bien en parlant de pulvériser, c'est quoi la vitesse maximale que tu peux obtenir ? "***
...
> Au moment de cet entretien, Spline était en pleine pré-production de la vidéo de Squeezie ***"Qui aura l'objet piégé ?"*** pour laquelle ***Spline*** a assuré la mise en œuvre du
>  robot ! 
>  ![](https://youtu.be/vRAPfDSmBGM?si=clQ71IHjQtQ1Apbi&t=2520)
>  Vous pouvez aussi découvrir juste ici [l'article de PackShot Mag](https://www.packshotmag.com/live-feeds/spline-porte-squeezie-avec-son-nouveau-bras-robot-bob/) qui détaille justement la mise en œuvre de ce nouveau robot **"Bob"**. Et rien que pour les yeux, appréciez justement Antoine en train de tester l'installation avant le tournage : 

<div style="height: 70vh; max-width: 100%; margin: 0 auto; aspect-ratio: 9/16; position: relative;">
...
*Et donc quand on a monté la boîte, il n'y avait pas vraiment de logiciel qu'on pouvait acheter. Il y avait d'autres sociétés qui avaient leurs logiciels, comme [Mark Roberts](https://www.mrmoco.com/), [le Bolt](https://www.mrmoco.com/motion-control/bolt/). Mais nous au début pendant plusieurs années on avait rien. On a essayé de faire développer des choses par des gens, mais ce n'est pas des gens qui utilisent des robots pour ce qu'on fait. Il y a un peu une déconnexion entre les programmeurs, les roboticiens et le monde du cinéma. Il fallait relier plein d'univers différents et on a galéré.*
...
![](https://www.youtube.com/watch?v=FNSjZ_2hHqc)
...
<div style="display: flex; justify-content: center;">
<blockquote class="instagram-media" data-instgrm-permalink="https://www.instagram.com/reel/DRcj5KgAUnT/" data-instgrm-version="14">
</blockquote>
</div>
<script async src="//www.instagram.com/embed.js"></script>
...
*C'est comme tout, ça a de mauvais aspects. Ces mauvais aspects peuvent entraîner des crises. Plein de gens voudraient les détourner pour en faire des mauvaises activités.* 
*Tu peux mettre plein de règles pour essayer d'empêcher, ou atténuer ces mauvaises aspects, et je pense que pour l'IA il n'y a pas encore eu ces modérations. Je pense que l'IA peut entraîner plein de problèmes, l'IA va entraîner des crises dans plein de secteurs.* 
...
![[Antoine Grasset.jpg|right]]


*J'ai acheté un tas de trucs absurdes, des gadgets, des trains miniatures qui servent à servir des shooters... Tu sais quand tu vas à Emmaüs, que tu vois un objet à la con, et tu te dis: "Noooon..." ? Moi je me dis: "Ouiiii !!".*
...
>*Depuis, Antoine a été contacté par [Club Maté](https://club-mate.fr/) pour recevoir un colis de fan pour avoir réparé leur site internet...*
